...
export const translations = {
  fr: {
    ...
    imageQuotaReached: "Limite de 20 photos par jour atteinte. Le compteur se réinitialise demain. Le mode vocal continue de fonctionner.",
  ...
  en: {
    ...
    imageQuotaReached: "Daily limit of 20 photos reached. The counter resets tomorrow. Voice mode continues to work.",
