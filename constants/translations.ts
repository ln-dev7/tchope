...
export const translations = {
  fr: {
    ...
    freeMessagesUsed: "Vous avez utilisé vos {limit} messages gratuits du jour.",
    freeMessagesUpgrade: "Revenez demain pour {limit} nouveaux messages, ou passez à Tchopé Plus pour un accès illimité.",
  ...
  en: {
    ...
    freeMessagesUsed: "You've used your {limit} free messages for today.",
    freeMessagesUpgrade: "Come back tomorrow for {limit} more, or upgrade to Tchopé Plus for unlimited access.",
    liveExplainTitle: "TchopAI Live",
